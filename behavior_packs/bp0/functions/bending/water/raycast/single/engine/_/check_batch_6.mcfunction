...
execute @s[scores={rc_aircount=!5}] ~~~ function bending/water/raycast/single/engine/_/run_batch_6
execute @s[scores={rc_aircount=5,rc_w_length=36..}] ~~~ function bending/water/raycast/single/engine/_/check_batch_7