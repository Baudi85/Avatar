...
execute @s[scores={rc_hitblock_c=1,rc_w_length=11..},tag=!rc_successful] ~~1.5 ~ summon nom:marker_raycast ^^^10
scoreboard players add @s[tag=!rc_successful,tag=!rc_in_air] rc_hitblock_c 1
execute @e[type=nom:marker_raycast,tag=!registered,c=1] ~~~ function bending/water/raycast/loop/on_hit/main
...
execute @s[scores={rc_hitblock_c=1,rc_w_length=12..},tag=!rc_successful] ~~1.5 ~ summon nom:marker_raycast ^^^11
scoreboard players add @s[tag=!rc_successful,tag=!rc_in_air] rc_hitblock_c 1
execute @e[type=nom:marker_raycast,tag=!registered,c=1] ~~~ function bending/water/raycast/loop/on_hit/main
...
execute @s[scores={rc_hitblock_c=1,rc_w_length=13..},tag=!rc_successful] ~~1.5 ~ summon nom:marker_raycast ^^^12
scoreboard players add @s[tag=!rc_successful,tag=!rc_in_air] rc_hitblock_c 1
execute @e[type=nom:marker_raycast,tag=!registered,c=1] ~~~ function bending/water/raycast/loop/on_hit/main
...
execute @s[scores={rc_hitblock_c=1,rc_w_length=14..},tag=!rc_successful] ~~1.5 ~ summon nom:marker_raycast ^^^13
scoreboard players add @s[tag=!rc_successful,tag=!rc_in_air] rc_hitblock_c 1
execute @e[type=nom:marker_raycast,tag=!registered,c=1] ~~~ function bending/water/raycast/loop/on_hit/main
...
execute @s[scores={rc_hitblock_c=1,rc_w_length=15..},tag=!rc_successful] ~~1.5 ~ summon nom:marker_raycast ^^^14
scoreboard players add @s[tag=!rc_successful,tag=!rc_in_air] rc_hitblock_c 1
execute @e[type=nom:marker_raycast,tag=!registered,c=1] ~~~ function bending/water/raycast/loop/on_hit/main
execute @s[tag=!rc_successful,scores={rc_w_length=16..}] ~~~ function bending/water/raycast/loop/engine/_/check_batch_4