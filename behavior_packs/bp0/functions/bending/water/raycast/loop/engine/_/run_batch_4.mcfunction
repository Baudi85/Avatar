...
execute @s[scores={rc_hitblock_c=1,rc_w_length=16..},tag=!rc_successful] ~~1.5 ~ summon nom:marker_raycast ^^^15
...
execute @s[scores={rc_hitblock_c=1,rc_w_length=17..},tag=!rc_successful] ~~1.5 ~ summon nom:marker_raycast ^^^16
scoreboard players add @s[tag=!rc_successful,tag=!rc_in_air] rc_hitblock_c 1
execute @e[type=nom:marker_raycast,tag=!registered,c=1] ~~~ function bending/water/raycast/loop/on_hit/main
...
execute @s[scores={rc_hitblock_c=1,rc_w_length=18..},tag=!rc_successful] ~~1.5 ~ summon nom:marker_raycast ^^^17
scoreboard players add @s[tag=!rc_successful,tag=!rc_in_air] rc_hitblock_c 1
execute @e[type=nom:marker_raycast,tag=!registered,c=1] ~~~ function bending/water/raycast/loop/on_hit/main
...
execute @s[scores={rc_hitblock_c=1,rc_w_length=19..},tag=!rc_successful] ~~1.5 ~ summon nom:marker_raycast ^^^18
scoreboard players add @s[tag=!rc_successful,tag=!rc_in_air] rc_hitblock_c 1
execute @e[type=nom:marker_raycast,tag=!registered,c=1] ~~~ function bending/water/raycast/loop/on_hit/main
...
execute @s[scores={rc_hitblock_c=1,rc_w_length=20..},tag=!rc_successful] ~~1.5 ~ summon nom:marker_raycast ^^^19
scoreboard players add @s[tag=!rc_successful,tag=!rc_in_air] rc_hitblock_c 1
execute @e[type=nom:marker_raycast,tag=!registered,c=1] ~~~ function bending/water/raycast/loop/on_hit/main
execute @s[tag=!rc_successful,scores={rc_w_length=21..}] ~~~ function bending/water/raycast/loop/engine/_/check_batch_5