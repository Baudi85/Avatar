...
execute @s[scores={rc_hitblock_c=1,rc_w_length=36..},tag=!rc_successful] ~~1.5 ~ summon nom:marker_raycast ^^^35
...
execute @s[scores={rc_hitblock_c=1,rc_w_length=37..},tag=!rc_successful] ~~1.5 ~ summon nom:marker_raycast ^^^36
scoreboard players add @s[tag=!rc_successful,tag=!rc_in_air] rc_hitblock_c 1
execute @e[type=nom:marker_raycast,tag=!registered,c=1] ~~~ function bending/water/raycast/loop/on_hit/main
...
execute @s[scores={rc_hitblock_c=1,rc_w_length=38..},tag=!rc_successful] ~~1.5 ~ summon nom:marker_raycast ^^^37
scoreboard players add @s[tag=!rc_successful,tag=!rc_in_air] rc_hitblock_c 1
execute @e[type=nom:marker_raycast,tag=!registered,c=1] ~~~ function bending/water/raycast/loop/on_hit/main
...
execute @s[scores={rc_hitblock_c=1,rc_w_length=39..},tag=!rc_successful] ~~1.5 ~ summon nom:marker_raycast ^^^38
scoreboard players add @s[tag=!rc_successful,tag=!rc_in_air] rc_hitblock_c 1
execute @e[type=nom:marker_raycast,tag=!registered,c=1] ~~~ function bending/water/raycast/loop/on_hit/main
...
execute @s[scores={rc_hitblock_c=1,rc_w_length=40..},tag=!rc_successful] ~~1.5 ~ summon nom:marker_raycast ^^^39
scoreboard players add @s[tag=!rc_successful,tag=!rc_in_air] rc_hitblock_c 1
execute @e[type=nom:marker_raycast,tag=!registered,c=1] ~~~ function bending/water/raycast/loop/on_hit/main