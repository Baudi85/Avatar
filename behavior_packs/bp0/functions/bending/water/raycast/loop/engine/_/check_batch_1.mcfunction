...
execute @s[scores={rc_aircount=!5}] ~~~ function bending/water/raycast/loop/engine/_/run_batch_1
execute @s[scores={rc_aircount=5,rc_w_length=11..}] ~~~ function bending/water/raycast/loop/engine/_/check_batch_2