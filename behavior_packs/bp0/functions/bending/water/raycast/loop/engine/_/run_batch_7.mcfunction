...
execute @s[scores={rc_hitblock_c=1,rc_w_length=31..},tag=!rc_successful] ~~1.5 ~ summon nom:marker_raycast ^^^30
...
execute @s[scores={rc_hitblock_c=1,rc_w_length=32..},tag=!rc_successful] ~~1.5 ~ summon nom:marker_raycast ^^^31
scoreboard players add @s[tag=!rc_successful,tag=!rc_in_air] rc_hitblock_c 1
execute @e[type=nom:marker_raycast,tag=!registered,c=1] ~~~ function bending/water/raycast/loop/on_hit/main
...
execute @s[scores={rc_hitblock_c=1,rc_w_length=33..},tag=!rc_successful] ~~1.5 ~ summon nom:marker_raycast ^^^32
scoreboard players add @s[tag=!rc_successful,tag=!rc_in_air] rc_hitblock_c 1
execute @e[type=nom:marker_raycast,tag=!registered,c=1] ~~~ function bending/water/raycast/loop/on_hit/main
...
execute @s[scores={rc_hitblock_c=1,rc_w_length=34..},tag=!rc_successful] ~~1.5 ~ summon nom:marker_raycast ^^^33
scoreboard players add @s[tag=!rc_successful,tag=!rc_in_air] rc_hitblock_c 1
execute @e[type=nom:marker_raycast,tag=!registered,c=1] ~~~ function bending/water/raycast/loop/on_hit/main
...
execute @s[scores={rc_hitblock_c=1,rc_w_length=35..},tag=!rc_successful] ~~1.5 ~ summon nom:marker_raycast ^^^34
scoreboard players add @s[tag=!rc_successful,tag=!rc_in_air] rc_hitblock_c 1
execute @e[type=nom:marker_raycast,tag=!registered,c=1] ~~~ function bending/water/raycast/loop/on_hit/main
execute @s[tag=!rc_successful,scores={rc_w_length=36..}] ~~~ function bending/water/raycast/loop/engine/_/check_batch_8