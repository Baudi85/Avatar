...
execute @s[scores={rc_aircount=!5}] ~~~ function bending/earth/raycast/loop/engine/_/run_batch_5
execute @s[scores={rc_aircount=5,rc_e_length=31..}] ~~~ function bending/earth/raycast/loop/engine/_/check_batch_6