...
execute @s[scores={rc_aircount=!5}] ~~~ function bending/earth/raycast/loop/engine/_/run_batch_2
execute @s[scores={rc_aircount=5,rc_e_length=16..}] ~~~ function bending/earth/raycast/loop/engine/_/check_batch_3