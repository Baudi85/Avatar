...
execute @s[scores={rc_aircount=!5}] ~~~ function bending/earth/raycast/single/engine/_/run_batch_4
execute @s[scores={rc_aircount=5,rc_e_length=26..}] ~~~ function bending/earth/raycast/single/engine/_/check_batch_5