...
execute @s[scores={rc_aircount=!5}] ~~~ function bending/earth/raycast/single/engine/_/run_batch_6
execute @s[scores={rc_aircount=5,rc_e_length=36..}] ~~~ function bending/earth/raycast/single/engine/_/check_batch_7