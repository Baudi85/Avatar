...
execute @s[scores={rc_hitblock_c=1,rc_e_length=1..},tag=!rc_successful] ~~1.5 ~ summon nom:marker_raycast ^^^0 nom:despawn
...
execute @s[scores={rc_hitblock_c=1,rc_e_length=2..},tag=!rc_successful] ~~1.5 ~ summon nom:marker_raycast ^^^1 nom:despawn
scoreboard players add @s[tag=!rc_successful,tag=!rc_in_air] rc_hitblock_c 1
execute @e[type=nom:marker_raycast,tag=!registered,c=1] ~~~ function bending/earth/raycast/single/on_hit/main
...
execute @s[scores={rc_hitblock_c=1,rc_e_length=3..},tag=!rc_successful] ~~1.5 ~ summon nom:marker_raycast ^^^2 nom:despawn
scoreboard players add @s[tag=!rc_successful,tag=!rc_in_air] rc_hitblock_c 1
execute @e[type=nom:marker_raycast,tag=!registered,c=1] ~~~ function bending/earth/raycast/single/on_hit/main
...
execute @s[scores={rc_hitblock_c=1,rc_e_length=4..},tag=!rc_successful] ~~1.5 ~ summon nom:marker_raycast ^^^3 nom:despawn
scoreboard players add @s[tag=!rc_successful,tag=!rc_in_air] rc_hitblock_c 1
execute @e[type=nom:marker_raycast,tag=!registered,c=1] ~~~ function bending/earth/raycast/single/on_hit/main
...
execute @s[scores={rc_hitblock_c=1,rc_e_length=5..},tag=!rc_successful] ~~1.5 ~ summon nom:marker_raycast ^^^4 nom:despawn
scoreboard players add @s[tag=!rc_successful,tag=!rc_in_air] rc_hitblock_c 1
execute @e[type=nom:marker_raycast,tag=!registered,c=1] ~~~ function bending/earth/raycast/single/on_hit/main
execute @s[tag=!rc_successful,scores={rc_e_length=6..}] ~~~ function bending/earth/raycast/single/engine/_/check_batch_2