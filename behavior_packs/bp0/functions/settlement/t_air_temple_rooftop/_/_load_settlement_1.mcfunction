tellraw @a[tag=dev] {"rawtext":[ { "text": "§6Settlement<t_temple_rooftop>:§r§6 Loaded settlement_1" }]}
function settlement/t_air_temple_rooftop/_/_cleanup
structure load nom:1383.91.-1834.1405.96.-1814.settlement_1 1383 91 -1834
