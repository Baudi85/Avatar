tellraw @a[tag=dev] {"rawtext":[ { "text": "§6Settlement<t_temple_rooftop>:§r§6 Saved settlement_0" }]}
...
structure save nom:1383.91.-1834.1405.96.-1814.settlement_0 1383 91 -1834 1405 96 -1814 disk
