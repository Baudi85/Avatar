tellraw @a[tag=dev] {"rawtext":[ { "text": "§6Settlement<t_box_apartment>:§r§6 Saved settlement_2" }]}
...
structure save nom:67.16.-97.89.24.-79.settlement_2 67 16 -97 89 24 -79 disk
