tellraw @a[tag=dev] {"rawtext":[ { "text": "§6Settlement<t_temple_sanctuary>:§r§6 Saved settlement_1" }]}
...
structure save nom:1345.124.-1790.1348.134.-1784.settlement_1 1345 124 -1790 1348 134 -1784 disk
