tellraw @a[tag=dev] {"rawtext":[ { "text": "§6Settlement<t_zhao_ship>:§r§6 Saved settlement_1" }]}
...
structure save nom:1382.31.-199.1402.36.-161.settlement_1 1382 31 -199 1402 36 -161 disk
