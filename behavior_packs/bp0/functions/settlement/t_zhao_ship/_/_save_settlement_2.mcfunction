tellraw @a[tag=dev] {"rawtext":[ { "text": "§6Settlement<t_zhao_ship>:§r§6 Saved settlement_2" }]}
...
structure save nom:1382.31.-199.1402.36.-161.settlement_2 1382 31 -199 1402 36 -161 disk
