tellraw @a[tag=dev] {"rawtext":[ { "text": "§6Settlement<t_clover_courtyard>:§r§6 Saved settlement_1" }]}
...
structure save nom:1341.135.-1866.1359.144.-1845.settlement_1 1341 135 -1866 1359 144 -1845 disk
...
structure save nom:1319.133.-1844.1381.153.-1812.settlement_1 1319 133 -1844 1381 153 -1812 disk
