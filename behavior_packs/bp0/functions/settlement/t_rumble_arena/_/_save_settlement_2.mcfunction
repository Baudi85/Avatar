tellraw @a[tag=dev] {"rawtext":[ { "text": "§6Settlement<t_rumble_arena>:§r§6 Saved settlement_2" }]}
...
structure save nom:96.31.1744.148.42.1774.settlement_2 96 31 1744 148 42 1774 disk
...
structure save nom:113.30.1700.131.48.1714.settlement_2 113 30 1700 131 48 1714 disk
